...
// AuthType and Qwen-specific error imports removed
// Quota error detection imports also removed as OAuth is no longer supported
...
export async function retryWithBackoff<T>(
  ...
  // onPersistent429 and authType removed as OAuth is no longer supported
