...
export type { AnyToolInvocation };
// MCPOAuthConfig removed
...
export class Config {
  ...
  async refreshAuth(authMethod: AuthType) {
    ...
    // OAuth methods have been removed, no need to handle Genai to Vertex transition
